...
model = LeNet.build( width=20, height=20, depth=1, classes=2, weightsPath='output/lenet_weights.hdf5' if args["load_model"] > 0 else None )
...
if args["load_model"] < 0:
	print("[INFO] training...")
	model.fit(trainData, trainLabels, batch_size=48, nb_epoch=3,verbose=1)
